...
export default function CheckoutScreen() {
  ...
  const { items: cartItems, subtotal, deliveryCost, total, clearCart } = useCartStore();
  ...
  const handleSubmitOrder = () => {
    if (!checkoutForm.name || !checkoutForm.phone || !checkoutForm.address || !checkoutForm.deliveryDate) {
                ...
                <View style={{ gap: 16 }}>
                  ...
                  <View style={{ gap: 8 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                      ...
                      />
                      <ThemedText type="defaultSemiBold" style={{ color: adaptiveColor("#374151", "#d1d5db") }}>
                        Имя *
                      </ThemedText>
                    </View>
                    <TextInput
                  ...
                  <View style={{ gap: 8 }}>
                    ...
                    >
                      <ThemedText style={{ 
                        color: checkoutForm.address ? adaptiveColor("#111827", "#f9fafb") : adaptiveColor("#9ca3af", "#6b7280"),
                        flex: 1,
                        fontSize: 16,
                      }}>
                        {checkoutForm.address || "Нажмите для выбора адреса"}
                      </ThemedText>
                      <Ionicons name="chevron-forward" size={20} color={adaptiveColor("#6b7280", "#9ca3af")} />
                    </Pressable>
                  </View>
                  ...
                  <View style={{ gap: 8 }}>
                    ...
                    >
                      <ThemedText style={{ 
                        ...
                        {new Date(checkoutForm.deliveryDate).toLocaleDateString("ru-RU", {
                          weekday: 'short',
                          day: 'numeric',
                          month: 'short',
                        })}
                    ...
                    {showDatePicker && (
                      <RNDateTimePicker
                        ...
                        maximumDate={new Date(Date.now() + 86400000 + 6 * 86400000)} // +7 дней от завтра
                        onChange={(event, selectedDate) => {
                          setShowDatePicker(false);
                          if (selectedDate) {
                            setCheckoutForm({ ...checkoutForm, deliveryDate: selectedDate });
                          }
                        }}
                      />
                    )}
              ...
              >
                ...
                <View style={{ gap: 12 }}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <ThemedText style={{ color: adaptiveColor("#6b7280", "#9ca3af") }}>
                      Товары ({cartItems.length})
                    </ThemedText>
                    <ThemedText style={{ color: adaptiveColor("#111827", "#f9fafb") }}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <ThemedText style={{ 
                      color: deliveryCost === 0 ? "#10b981" : adaptiveColor("#111827", "#f9fafb")
                    }}>
